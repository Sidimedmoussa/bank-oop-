...
private:
    ...
    static vector<clsBankClient> _LoadClientsDataFromFile()
    {
        ...
        fstream MyFile;
        MyFile.open("client_data.txt", ios::in); // read Mode
    ...
    static void _SaveCleintsDataToFile(vector<clsBankClient> vClients)
    {
        ...
        fstream MyFile;
        MyFile.open("client_data.txt", ios::out); // overwrite
    ...
    {
        fstream MyFile;
        MyFile.open("client_data.txt", ios::out | ios::app);
...
public:
    ...
    static clsBankClient Find(string AccountNumber, string PinCode)
    {
        ...
        fstream MyFile;
        MyFile.open("client_data.txt.txt", ios::in); // read Mode
